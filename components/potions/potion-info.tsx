import { PotionHeader, PotionInfoCard, PotionStats } from "@/components/potions/potion-common"
...
export default function PotionInfo({ potion }: PotionInfoType) {
  ...
  const subTitle = "Discover the magical properties of this enchanted group"
  const {
    name,
    owner, description, stargazers_count,
    forks_count, potionEffect, topics, language, updated_at, magicalType,
  } = potion
  return (
            ...
            <div className="space-y-4">
              ...
              <PotionInfoCard title="Last Updated">
                <div className="flex items-center gap-2">
                  ...
                  <span>{new Date(updated_at).toLocaleDateString("en-US", {
                    year: "numeric",
                    month: "long",
                    day: "numeric"
                  })}</span>
